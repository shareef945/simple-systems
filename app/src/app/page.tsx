...
const FAQS = [
  {
    ...
    a: "No! Any Notion plan works, including the free plan.",
  },
  {
    q: "What if I already have candidates in Notion?",
    a: "You can import them or just start fresh - whatever works.",
  },
  {
    q: "Can I change my databases later?",
    a: "Yes, you can update your database selection anytime from settings.",
  },
  {
    q: "Is there a trial?",
    a: "Yes, you can try the full setup for free. No credit card needed.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <p className="mt-6 text-lg text-zinc-500 max-w-md leading-relaxed">
                Connect your Notion. Share a link. Get candidates — no
                spreadsheets, no extra tools, no headache.
              </p>
            ...
            {[
              {
                ...
                desc: "Sign in with Notion. We only access what we need.",
              },
              {
                icon: Database,
                title: "Pick databases",
                desc: "Choose your Candidates, Roles, and Stages databases.",
              },
              {
                icon: Link2,
                title: "Share link",
                desc: "Get your application URL. Start receiving candidates.",
              },
            ].map((item, i) => (
              <div
                key={item.title}
                className="relative p-8 rounded-2xl border border-zinc-100 bg-white"
              >
      ...
      <section className="py-24 px-6 bg-zinc-900">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white">
            $300
            <span className="text-zinc-500 text-2xl font-normal">
              , forever
            </span>
          </h2>
          ...
          <div className="mt-10">
            <Link href="/onboarding">
              <Button
                size="lg"
                className="h-12 px-10 bg-orange-600 hover:bg-orange-700"
              >
          ...
          <div className="space-y-4">
            {FAQS.map((faq, i) => (
              ...
              >
                ...
                <div className="px-4 pb-4 text-zinc-500">{faq.a}</div>
              </details>
            ))}
          </div>
        </div>
